...
> 최종 갱신: 2026-09-26 (M3 종료 점검 — 구멍 2개 발견, M4 준비 문서 작성)
...
### 1️⃣ 다음 작업 — M3 를 닫기 전 구멍 2개 → **[05-m3-exit-m4-readiness.md](05-m3-exit-m4-readiness.md)**

종료 체크리스트를 코드로 확인했더니 **태스크는 끝났는데 인수기준이 비어 있는 곳이 둘** 있었다.
