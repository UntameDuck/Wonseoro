...
| 구분 | 태스크 |
|---|---|
| ✅ 완료 | 백엔드 11개 + T-M1-09 + **프론트 핵심 10개** (20·21·22·23·24·27·28·29·30·31·32) |
| 🔜 남음 | T-M2-25 서류 업로드 화면 · T-M2-26 검토·결제 화면 보강 |
| 🔜 프론트 | T-M2-20~32 (전체) |
...
| T-M2-24 | 3. 추가정보 | §07, §01 A5 | 글자수·필수여부 표시. **JSON Schema 동적 렌더는 미구현** | 🟡 |
