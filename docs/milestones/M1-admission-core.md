...
| 구분 | 태스크 |
|---|---|
| ✅ 완료 | T-M1-02 · 03 · 04(로직) · 05 · 07 · 08 · 13 · 14 |
| 🟡 DDL 배치 완료, 적용 대기 | T-M1-01 (Docker 기동 필요) |
| 🔴 남음 (저장소 어댑터 필요) | T-M1-04(Postgres) · 06 · 09 · 10 · 11 · 12 |

검증: 단위 테스트 **50개 전부 통과** (계약 적합성 17건 포함), `admission-api` 기동 및 응답 확인.
...
|---|---|---|---|---|---|
| T-M1-01 | DDL 적용 + 마이그레이션 러너 | 송리안 | §02 + 첨부 DDL | 20개 엔티티 생성, 정합성 제약 5종 확인 | 🟡 배치·정적검증 완료, DB 적용 대기 |
