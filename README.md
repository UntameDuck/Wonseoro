...
> 기준일 2026-09-26 · 전체 139개 태스크 중 **52개 완료** · 테스트 **230개 통과**
...
| M3 운영 안전장치 | **8/15** | 마감 정책 엔진, 설정 거버넌스, 4-way 대조, 증적 재구성, 의존성 차단, 서명된 적용 기록 |
...
- [설계 불일치 대장](docs/02-spec-discrepancy-register.md) — 설계서와 구현이 어긋난 37건의 판정 기록
